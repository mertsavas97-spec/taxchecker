...
export function QuarterlyTaxCalculator() {
  ...
  const breakdown = buildQuarterlyBreakdownCards(result.summary, result.details);
  ...
  return (
    <div className="space-y-5">
        ...
        <Card className="shadow-tc-sm">
          ...
          <CardContent>
            <form
              ...
              aria-label="Quarterly tax calculator inputs"
            >
      ...
      <BreakdownResults
        items={breakdown}
        description="Form 1040-ES due dates, safe harbor metrics, and annual tax components."
      />
      ...
      <NextStepsPanel journeyId="quarterly-tax" />
